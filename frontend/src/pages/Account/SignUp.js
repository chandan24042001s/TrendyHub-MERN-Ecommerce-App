...
const SignUp = () => {
  ...
  const registerUserAPI = async (name, email, password) => {
    try {
       const response = await axios.post('https://trendyhub.onrender.com/api/users/register', {
         name,
         email,
         password,
       }, {
        headers: {
          ...
          // Include other headers here if needed, for example:
  ...
  const handleSignUp = async (e) => {
    ...
    if (checked) {
      ...
      if (
        ...
        registerUserAPI(clientName, email, password);
        setSuccessMsg(
